...
{if $filename == '/news.htm'}
  {include file="../common/displayHeader.tpl" 
      title="Home &gt; <a href=$filename>News</a> // <a href=$filename&action=showComments&newsID=`$thread->id`>$escapedThreadTitle</a>"
      noDisclaimer=1}
{else}
  {if $showThreadName}
    {include file="../common/displayHeader.tpl" 
      title="Inside &gt; <a href=forum.htm>Forum</a> // <a href=forum.htm?board=`$board->id`>`$board->name`</a> // <a href=forum.htm?thread=`$thread->id`>$escapedThreadTitle</a>"}
  {else}
    {include file="../common/displayHeader.tpl" 
