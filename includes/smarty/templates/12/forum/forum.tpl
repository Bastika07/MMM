...
{foreach key=key item=val from=$data}
  ...
  <tr>
    ...
    {if $val.new}{html_image file="/esportarena/forumicons/new_thread.png" alt="Neue Threads im Board"}{else}{html_image file="/esportarena/forumicons/no_new_thread.png" alt="Keine neuen Threads im Board"}{/if}
    </td>
