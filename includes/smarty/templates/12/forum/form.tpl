...
{if $filename == '/esportarena/news.htm'}
  <h1>News kommentieren</h1>
<img src="/esportarena/style/content_bg_top.png" width="800" height="18"><br>
...
{if $filename == '/esportarena/news.htm'}
 ...
 <img src="/esportarena/style/content_bg_bottom.png" width="800" height="1">
 <br><br>
{/if}