<?php
#
# Menü für den Adminbereich
#

$currentUser = new User();
$rights = $currentUser->getRights();

function showlink($label, $href, $required_rights) {
    global $rights;
    echo '  <li>';
...
?>
<ul>
  <li><a href="index.php">Home/Termine</a></li>
</ul>

<h2>User: <?= $currentUser->name; ?></h2>
<ul>
	<li><a href="benutzerprofil.php">Mein Profil</a></li>
...
<?php
# BILDERADMIN
showlink('Slider', 'sliderbilder.php', 'BILDERADMIN');
showlink('Verpflegung', 'verpflegungbilder.php', 'BILDERADMIN');
showlink('Lokation', 'locationbilder.php', 'BILDERADMIN');
showlink('Netzwerk', 'netzwerkbilder.php', 'BILDERADMIN');
showlink('Sponsorenbilder', 'sponsorbilder.php', 'SPONSORINGADMIN');
?>
</ul>
