...
<h4>Ich möchte den Newsletter weiterhin erhalten!</h4>
								  <form action="/" method="post"><input type="submit" value="Abonnieren" name="btnNewsletterOK" class="btnNewsletterOK"/>
			   </form><br>
<h4>Ich möchte den Newsletter nicht mehr erhalten. :(</h4>		   
			   <form action="/" method="post"><input type="submit" value="Abbestellen" name="btnNewsletterCancel" class="btnNewsletterCancel"/>
			   </form>
				  </div>
			</div>';
	}
